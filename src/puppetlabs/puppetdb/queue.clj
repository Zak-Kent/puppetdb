...
(deftype SortedCommandBuffer [^TreeMap fifo-queue
                              ...
                              ^clojure.lang.IFn bash-update-fn]
  async-protos/Buffer
  (full? [this]
        ...
        (let [^CommandRef maybe-old-command (.get certnames-map [command-type certname])]
          (cond
            ...
            (do
              ...
              (.put fifo-queue (:id cmdref) cmdref)
              (bash-update-fn (:command maybe-old-command) (:version maybe-old-command))
...
(defn sorted-command-buffer
  ...
  ([^long n ^clojure.lang.IFn delete-update-fn bash-update-fn]
   ...
   (SortedCommandBuffer. (TreeMap.) (HashMap.) n delete-update-fn bash-update-fn)))
